...
<section class="auth-card">
  ...
  <form action="<?= htmlspecialchars($BASE) ?>/actions/register.php" method="post" class="form">
    <label>Nama
    ...
    <p class="muted">Sudah punya akun? <a href="<?= htmlspecialchars($BASE) ?>/login.php">Masuk</a></p>
  </form>
</section>
